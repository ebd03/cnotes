...
#include <stdlib.h>
#include <string.h>
#include "Header.h" /* Include related header file */
...
int main()
{
    ...
    FILE* pPets;
    if ((pPets = fopen("//Users//Eoghan//xCode//DCUEXAM//DCUEXAM//DCUEXAM//pets.txt", "w")) == NULL)
    {
    ...
    FILE *pEquipment;
    if ((pEquipment = fopen("//Users//Eoghan//xCode//DCUEXAM//DCUEXAM//DCUEXAM//equip.txt", "w")) == NULL)
    {
    ...
    if ((pPets = fopen("//Users//Eoghan//xCode//DCUEXAM//DCUEXAM//DCUEXAM//pets.txt", "r")) == NULL)
    {
    ...
    if ((pEquipment = fopen("//Users//Eoghan//xCode//DCUEXAM//DCUEXAM//DCUEXAM//equip.txt", "r")) == NULL)
    {
    ...
    if((pAllData = fopen("//Users//Eoghan//xCode//DCUEXAM//DCUEXAM//DCUEXAM//finaldata.txt", "w")) == NULL)
    {
